...
"""
    ...
    INTENT_PATTERNS = {
        ...
        "home_overview": ["helyzet", "állapot", "minden", "otthon", "overview", "status"]
    }
    ...
    async def _llm_summarize(
        ...
        try:
            ...
            logger.debug(f"Calling LLM summarizer: model={self.model}, api_base={api_base}")
            ...
            try:
                ...
                if json_match:
                    ...
                    return ConversationSummary(
                        ...
                        context_entities=summary_data.get("context_entities", []),
                        confidence=0.8,
                        reasoning=f"LLM-based analysis (JSON extracted)"
                    )
                return None
