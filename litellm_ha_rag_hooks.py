...
def litellm_post_processor(
    ...
    3. Továbbítja ezeket a műveleteket a HA-RAG Bridge API-nak végrehajtásra
    4. Hozzáadja a végrehajtási eredményeket a válaszhoz
    ...
    Returns:
        A módosított válasz
    """
    # Ellenőrizzük, hogy engedélyezve van-e a tool végrehajtás
    if os.getenv("ENABLE_HA_TOOL_EXECUTION", "false").lower() != "true":
        logger.info(
    ...
    try:
        # Küldjük a műveleteket végrehajtásra a ha-rag-bridge API-nak
